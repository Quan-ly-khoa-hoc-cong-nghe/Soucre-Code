...
const ListArticleReviewDepartment = () => {
  ...
  const handleDelete = (maHoSo) => {
    if (window.confirm("Are you sure you want to delete this article?")) {
      axios
        .post(
          "http://localhost/Soucre-Code/BackEnd/Api/ThamDinhBaiBaoApi/HoSoBaiBaoKH_Api.php?action=delete",
          { MaHoSo: maHoSo }
        )
        .then((response) => {
...
export default ListArticleReviewDepartment;
