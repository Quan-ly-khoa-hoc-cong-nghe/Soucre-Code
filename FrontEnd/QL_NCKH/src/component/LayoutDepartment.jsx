...
import { FaGift, FaUpload, FaComment, FaChartBar, FaBars, FaTimes, FaSignOutAlt, FaBook, FaClipboardList } from 'react-icons/fa';
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-center space-x-3 hover:bg-[#8AADE0] text-black hover:text-[#419a7c] p-2 rounded">
                            <Link to="/" className="flex items-center space-x-3">
                                <FaChartBar />
                                <span className="font-semibold">Dashboard LayoutDepartment</span>
                            </Link>
                        </li>
                        <li className="flex items-center space-x-3 hover:bg-[#8AADE0] text-black hover:text-[#419a7c] p-2 rounded">
